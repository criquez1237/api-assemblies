...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
        ...
        .authorizeHttpRequests(auth -> auth
            // Allow unauthenticated access to authentication endpoints and Swagger UI/docs
            .requestMatchers("/auth/**", "/swagger-ui.html", "/swagger-ui/**", "/v3/api-docs/**", "/webhooks/**", "/files/**", "/resend/**")
                        .permitAll()
                        .anyRequest()
                        .authenticated())
